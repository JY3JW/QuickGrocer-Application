...
class CompleteOrderScreenBuyer extends StatefulWidget {
  const CompleteOrderScreenBuyer({super.key});

  @override
  State<CompleteOrderScreenBuyer> createState() =>
      _CompleteOrderScreenBuyerState();
}

class _CompleteOrderScreenBuyerState extends State<CompleteOrderScreenBuyer> {
  @override
      ...
      child: Container(
        ...
        child: Column(
          children: [
            Container(
              child: FutureBuilder(
                  future: orderController.singleBuyerOrdersCompleted(),
