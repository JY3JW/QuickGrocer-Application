...
class ViewGroceryDetailsFromCartScreen extends StatefulWidget {
  final CartItemModel grocery;
  const ViewGroceryDetailsFromCartScreen({
    super.key,
    required this.grocery,
  });

  @override
  State<ViewGroceryDetailsFromCartScreen> createState() =>
      _ViewGroceryDetailsFromCartScreenState();
}

class _ViewGroceryDetailsFromCartScreenState
    extends State<ViewGroceryDetailsFromCartScreen> {
  @override
  Widget build(BuildContext context) {
    var iconColorWithoutBackground =
        Get.isDarkMode ? Colors.white : Colors.black;
    var detailsBackground =
        Get.isDarkMode ? AppColors.greyColor4 : AppColors.greyColor1;
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  child: Image.network(widget.grocery.image, fit: BoxFit.cover),
                ),
              ],
            ),
            const SizedBox(height: 36),
          ...
          child:
            ...
            ElevatedButton.icon(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  side: widget.grocery.quantity == 0
                ...
                label: widget.grocery.quantity == 0
                    ? Text(outOfStock)
                    : Text(addToCart)),
          ]),
        ),
