...
class ViewGroceryDetailsScreen extends StatefulWidget {
  ...
  const ViewGroceryDetailsScreen({
    super.key,
    required this.grocery,
  });

  @override
  State<ViewGroceryDetailsScreen> createState() =>
      _ViewGroceryDetailsScreenState();
}
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  child:
                      Image.network(widget.grocery.imageUrl, fit: BoxFit.cover),
                ),
              ],
            ),
            const SizedBox(height: 36),
